...
/* harmony import */ var babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
    ...
    if (conf.watch) {
      entries_default()(function (k, v) {
        ...
        if (typeof v === 'function') {
          ...
          _self.$watch(k, v.handler, { immediate: immediate, deep: deep });
        }
      });
    }
