...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  addComp: __WEBPACK_IMPORTED_MODULE_4_fansion_base___default.a.builder.register(components),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template__ = __webpack_require__(19);
var _this = this;
...
var rules = [__WEBPACK_IMPORTED_MODULE_1__template__["a" /* default */].rule];
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  addMeta: __WEBPACK_IMPORTED_MODULE_0_fansion_base___default.a.builder.register(metas, 'fac-name'),

  addRule: __WEBPACK_IMPORTED_MODULE_0_fansion_base___default.a.builder.collection(rules),

  init: function init(options) {
    if (!options) {
      return;
    }
    _this.addMeta(options.metas);
    _this.addRule(options.rules);
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fayout__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__layouts__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comps__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fac__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__meta__ = __webpack_require__(9);
...
var pageMetaRule = function pageMetaRule(path, pageMetas) {
  if (path.startsWith('$')) {
    var _meta = { props: { config: path.substring(1) }, component: __WEBPACK_IMPORTED_MODULE_4__fac__["a" /* default */] };
    pageMetas.addPageMeta(path, _meta);
    return _meta;
  }
};
...
var init = function init(option) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(__WEBPACK_IMPORTED_MODULE_6__options__["a" /* default */], option);
  __WEBPACK_IMPORTED_MODULE_5__meta__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_6__options__["a" /* default */].meta);
  __WEBPACK_IMPORTED_MODULE_2__layouts__["a" /* default */].addLayout(__WEBPACK_IMPORTED_MODULE_6__options__["a" /* default */].layouts);
  __WEBPACK_IMPORTED_MODULE_3__comps__["a" /* default */].addComp(__WEBPACK_IMPORTED_MODULE_6__options__["a" /* default */].components);
};

/* harmony default export */ __webpack_exports__["default"] = ({
  version: version,
  init: init,
  fayout: __WEBPACK_IMPORTED_MODULE_1__fayout__["a" /* default */],
  layouts: __WEBPACK_IMPORTED_MODULE_2__layouts__["a" /* default */],
  comps: __WEBPACK_IMPORTED_MODULE_3__comps__["a" /* default */],
  fac: __WEBPACK_IMPORTED_MODULE_4__fac__["a" /* default */],
  meta: __WEBPACK_IMPORTED_MODULE_5__meta__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__meta__ = __webpack_require__(9);
...
function getMeta(vm) {
  var meta = typeof vm.meta === 'string' ? __WEBPACK_IMPORTED_MODULE_6__meta__["a" /* default */].getMeta(vm.meta) : vm.meta;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    if (layout.exist) {
      ...
      toRender(this, '<layout :meta="layoutConf" v-loading="pageLoading">' + template + '</layout>', __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_assign___default()({ layout: layoutComp }, components));
    } else {
